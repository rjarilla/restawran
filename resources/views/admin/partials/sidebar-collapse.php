<div id="miniSidebar">
  ...
  <ul class="navbar-nav flex-column">
    ...
    <!-- REPORTS -->
   <li class="nav-item">
      <a class="nav-link" href="#reportsSubmenu" data-bs-toggle="collapse" aria-expanded="false">
        <span class="nav-icon">
      ...
      <ul class="collapse list-unstyled ms-4" id="reportsSubmenu">
        <li>
          <a class="nav-link" href="/public/admin/reports">All Reports</a>
        </li>
        <li>
          <a class="nav-link" href="/public/admin/reports/inventory-movement">Inventory Movement Report</a>
        </li>
      </ul>
    </li>
