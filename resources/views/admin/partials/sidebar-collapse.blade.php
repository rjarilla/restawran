@php
    ...
    $userOpen =
        ...
        request()->routeIs('admin.userprofile*') ||
        request()->routeIs('admin.userprofprivileges*');
...
<div id="miniSidebar">
    ...
    <ul class="navbar-nav flex-column">
        ...
        @if (in_array('PROD', $privs) || in_array('PROD_INV', $privs))
            <li class="nav-item">
                <button
                    class="nav-link w-100 text-start d-flex align-items-center justify-content-between {{ $productOpen ? '' : 'collapsed' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#productSubmenu"
                    aria-expanded="{{ $productOpen ? 'true' : 'false' }}" aria-controls="productSubmenu">
        ...
        @if (in_array('USER', $privs))
            <li class="nav-item">
                <button
                    class="nav-link w-100 text-start d-flex align-items-center justify-content-between {{ $userOpen ? '' : 'collapsed' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#userSubmenu"
                    aria-expanded="{{ $userOpen ? 'true' : 'false' }}" aria-controls="userSubmenu">
                    <span class="d-flex align-items-center gap-2">
                        <span class="nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
        ...
        @if (in_array('REPORTS', $privs))
            <li class="nav-item">
                <button
                    class="nav-link w-100 text-start d-flex align-items-center justify-content-between {{ $reportOpen ? '' : 'collapsed' }}"
                    type="button" data-bs-toggle="collapse" data-bs-target="#reportSubmenu"
                    aria-expanded="{{ $reportOpen ? 'true' : 'false' }}" aria-controls="reportSubmenu">
                    <span class="d-flex align-items-center gap-2">
                        <span class="nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                ...
                <div class="collapse {{ $reportOpen ? 'show' : '' }}" id="reportSubmenu">
                    <ul class="list-unstyled ms-4">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('admin.reports.paymentAnalytics') ? 'active' : '' }}"
                                href="{{ route('admin.reports.paymentAnalytics') }}">
                                <span class="nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round">
