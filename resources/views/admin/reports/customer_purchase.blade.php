    ...
    if (chartData && chartData.length > 0 && typeof ApexCharts !== 'undefined') {
        const options = {
            series: [{
                ...
                type: 'line',
                data: chartData.map(i => i.average)
            }],
            ...
            yaxis: [
                ...
                { opposite: true, title: { text: 'Average Revenue (₱)' } }
            ],
        ...
        document.querySelector('#dailySalesChart').innerHTML =
            '<div class="text-center text-muted p-4">No daily sales data available for the selected period.</div>';
    }
});
</script>
@endsection
